const LineMdSunRisingTwotoneLoop: React.FC<{ className: string }> = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <g stroke="currentColor" strokeLinecap="round" strokeWidth="2">
        <circle cx="12" cy="32" r="5" fill="currentColor" fillOpacity=".3">
...
export default LineMdSunRisingTwotoneLoop
